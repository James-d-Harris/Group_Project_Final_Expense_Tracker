        ...
        sortedExpenses.forEach((expense, index) => {
            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    <button class="delete-expense-button" onclick="deleteExpense('${expense._id}', ${index})">Delete</button>
                </td>
            `;
...
async function deleteExpense(expenseId, index) {
